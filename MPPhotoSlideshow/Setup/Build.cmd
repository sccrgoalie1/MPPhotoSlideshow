...
SET WIX_BUILD_LOCATION=%ProgramFilesPath%\WiX Toolset v3.7\bin
SET INTERMEDIATE_PATH=..\obj\%BUILD_TYPE%
SET OUTPUTNAME=..\bin\%BUILD_TYPE%\MPPhotoSlideshow.msi
SET BUNDLEOUTPUTNAME=..\bin\%BUILD_TYPE%\MPPhotoSlideshow.exe
...
"%WIX_BUILD_LOCATION%\light.exe" "%INTERMEDIATE_PATH%\setup.wixobj" -cultures:en-US -ext "%WIX_BUILD_LOCATION%\WixUIExtension.dll" -ext "%WIX_BUILD_LOCATION%\WixUtilExtension.dll" -loc setup-en-us.wxl -out "%OUTPUTNAME%"
